    ...
    try {
      var getCUDA = require('child_process').exec,
        getCUDAProc = getCUDA("nvidia-settings --help | grep version | head -n1 | sed 's/[^.0-9]*//g' | xargs | xargs", function(error, stdout, stderr) {
          ...
          if (driverversion.includes("455.") || driverversion.includes("460.") || driverversion.includes("465.") || driverversion.includes("470.") || driverversion.includes("495.") || driverversion.includes("470.") || driverversion.includes("510.") || driverversion.includes("511.")) {
            global.cuda = "11";
            //console.log("set");
          }
