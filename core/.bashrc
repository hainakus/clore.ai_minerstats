...
alias netrecovery='sudo su -c "cd /tmp; wget https://labs.minerstat.farm/repo/minerstat-os/-/raw/master/core/recovery.sh; sudo chmod 777 recovery.sh; sudo bash recovery.sh"'
